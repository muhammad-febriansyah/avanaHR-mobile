...
/// Face verification screen: a clean, full-bleed camera with green corner
/// brackets framing the centre (no heavy dark veil), a light top bar, and a
  ...
  Widget _frameArea() {
    return Align(
      ...
      child: SizedBox(
        ...
        child: Stack(
          children: [
            // Sweeping scan line while searching for a face.
            Obx(() {
            ...
            // Corner brackets — green once a valid face is framed.
            Positioned.fill(
              child: Obx(
                () => CustomPaint(
...
/// Subtle darkening only at the top and bottom edges so the top bar and status
/// card stay legible while the centre of the camera remains clear and bright.
...
/// Four rounded L-shaped corner brackets framing the capture window — the
/// classic scanner look. Turns green once a valid face is detected.
