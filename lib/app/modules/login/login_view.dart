...
class LoginView extends GetView<LoginController> {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [_header(cfg), _sheet(cfg)],
        ),
      ),
    );
  }
      ...
      child: Stack(
        children: [
          ...
          SafeArea(
            bottom: false,
            child: Padding(
              padding: EdgeInsets.fromLTRB(24.w, 40.h, 24.w, 70.h),
              child: Column(
  ...
  Widget _sheet(ConfigService cfg) {
    // Form card overhangs upward into the blue header, mirroring the home
    // attendance card straddling the blue/white seam.
    final poke = 40.h;
    return Container(
